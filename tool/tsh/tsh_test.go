...
func TestOIDCLogin(t *testing.T) {
	...
	populist, err := types.NewRoleV3("populist", types.RoleImplSpec{
	...
	dictator, err := types.NewRoleV3("dictator", types.RoleImplSpec{})
	require.NoError(t, err)
...
func TestSSHOnMultipleNodes(t *testing.T) {
	...
	sshLoginRole, err := types.NewRoleV3("ssh-login", types.RoleImplSpec{
		Allow: types.RoleConditions{
			Logins: []string{user.Username},
		},
	})
	...
	perSessionMFARole, err := types.NewRoleV3("mfa-login", types.RoleImplSpec{
		Allow: types.RoleConditions{
			Logins: []string{user.Username},
		},
...
func TestAccessRequestOnLeaf(t *testing.T) {
	...
	requester, err := types.NewRoleV3("requester", types.RoleImplSpec{
		Allow: types.RoleConditions{
			Request: &types.AccessRequestConditions{
				Roles: []string{"access"},
			},
