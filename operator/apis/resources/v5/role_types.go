...
type TeleportRoleSpec types.RoleImplSpec
...
func (r TeleportRole) ToTeleport() types.Role {
	return &types.RoleImpl{
		...
		Spec: types.RoleImplSpec(r.Spec),
	}
}
...
func (spec *TeleportRoleSpec) Marshal() ([]byte, error) {
	return (*types.RoleImplSpec)(spec).Marshal()
}

// Unmarshal deserializes a spec from binary data.
func (spec *TeleportRoleSpec) Unmarshal(data []byte) error {
	return (*types.RoleImplSpec)(spec).Unmarshal(data)
}
