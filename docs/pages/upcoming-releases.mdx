...
#### (Preview) TPM support for Device Trust

Teleport users on Windows can use trusted devices using a TPM module.
...
| Week of          | Description                                           |
|------------------|-------------------------------------------------------|
| May 8th, 2023    | Add support for hosted Access Request plugins (Slack) |
