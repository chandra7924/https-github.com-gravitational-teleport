...
func TestSAMLAuthRequest(t *testing.T) {
	...
	_, err = CreateRole(ctx, srv.Auth(), "baz", types.RoleImplSpec{})
	require.NoError(t, err)
...
func TestGenerateUserCertsWithRoleRequest(t *testing.T) {
	...
	dummyUserRole, err := types.NewRoleV3("dummy-user-role", types.RoleImplSpec{})
	require.NoError(t, err)
...
func TestStreamSessionEventsRBAC(t *testing.T) {
	...
	role, err := types.NewRoleV3("deny-sessions", types.RoleImplSpec{
		Allow: types.RoleConditions{
...
func TestKindClusterConfig(t *testing.T) {
	...
	t.Run("with KindClusterConfig privilege", func(t *testing.T) {
		role, err := types.NewRoleV3("test-role", types.RoleImplSpec{
			Allow: types.RoleConditions{
				Rules: []types.Rule{
...
func TestListResources_WithRoles(t *testing.T) {
	...
	createRole := func(ctx context.Context, t *testing.T, srv *Server, name string, labels map[string]apiutils.Strings) {
		role, err := types.NewRoleV3(name, types.RoleImplSpec{
			Allow: types.RoleConditions{
				NodeLabels: types.Labels{
					"*": []string{types.Wildcard},
				},
...
func createSnowflakeSessionTestUsers(t *testing.T, authServer *Server) (string, string, string) {
	...
	noAuthRole, err := types.NewRole("no-auth", types.RoleImplSpec{
		Allow: types.RoleConditions{
			Rules: []types.Rule{},
		},
	})
	...
	userWebAdmin, err := types.NewRole("user-and-web-admin", types.RoleImplSpec{
		Allow: types.RoleConditions{
			Rules: []types.Rule{
