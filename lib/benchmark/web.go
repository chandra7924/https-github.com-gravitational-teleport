...
// WebBenchmark is a benchmark suite that connects to the configured
...
func (s WebBenchmark) BenchBuilder(ctx context.Context, tc *client.TeleportClient) (WorkloadFunc, error) {
...
func (s WebBenchmark) runCommand(ctx context.Context, tc *client.TeleportClient, webSess *webSession, host, command string) error {
...
// access to.
func (s WebBenchmark) getServers(ctx context.Context, tc *client.TeleportClient) ([]types.Server, error) {
...
func (s WebBenchmark) connectToHost(ctx context.Context, tc *client.TeleportClient, webSession *webSession, host string) (*web.TerminalStream, error) {
