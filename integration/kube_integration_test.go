...
func testKubeExec(t *testing.T, suite *KubeSuite) {
	...
	role, err := types.NewRoleV3("kubemaster", types.RoleImplSpec{
...
func testKubeTrustedClustersClientCert(t *testing.T, suite *KubeSuite) {
	...
	mainRole, err := types.NewRoleV3("main-kube", types.RoleImplSpec{
		Allow: types.RoleConditions{
			Logins:     []string{username},
	...
	auxRole, err := types.NewRoleV3("aux-kube", types.RoleImplSpec{
		Allow: types.RoleConditions{
			Logins: []string{username},
...
func testKubeJoin(t *testing.T, suite *KubeSuite) {
	...
	require.NoError(t, err)
	joinRole, err := types.NewRoleV3("participant", types.RoleImplSpec{
		Allow: types.RoleConditions{
