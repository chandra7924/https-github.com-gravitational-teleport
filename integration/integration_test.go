...
func testSessionRecordingModes(t *testing.T, suite *integrationTestSuite) {
	...
	for name, test := range map[string]struct {
		...
		t.Run(name, func(t *testing.T) {
			...
			role, err := types.NewRoleV3("devs", types.RoleImplSpec{
...
func testMapRoles(t *testing.T, suite *integrationTestSuite) {
	...
	mainDevs := "main-devs"
	role, err := types.NewRoleV3(mainDevs, types.RoleImplSpec{
		Allow: types.RoleConditions{
			Logins: []string{username},
		},
	})
	...
	auxDevs := "aux-devs"
	role, err = types.NewRoleV3(auxDevs, types.RoleImplSpec{
		Allow: types.RoleConditions{
			Logins: []string{username},
		},
	})
...
func trustedClusters(t *testing.T, suite *integrationTestSuite, test trustedClusterTest) {
	...
	mainDevs := "main-devs"
	devsRole, err := types.NewRoleV3(mainDevs, types.RoleImplSpec{
		Allow: types.RoleConditions{
			Logins: []string{username},
		},
	})
	...
	adminsRole, err := types.NewRoleV3(mainAdmins, types.RoleImplSpec{
		Allow: types.RoleConditions{
	...
	mainOps := "main-ops"
	mainOpsRole, err := types.NewRoleV3(mainOps, types.RoleImplSpec{
		Allow: types.RoleConditions{
			Logins:        []string{username},
	...
	// role specified by mapping remote role "devs" to local role "local-devs"
	auxDevs := "aux-devs"
	auxRole, err := types.NewRoleV3(auxDevs, types.RoleImplSpec{
		Allow: types.RoleConditions{
			Logins: []string{username},
		},
	})
...
func testList(t *testing.T, suite *integrationTestSuite) {
	...
	for _, tt := range tests {
		t.Run(tt.inRoleName, func(t *testing.T) {
			...
			role, err := types.NewRoleV3(tt.inRoleName, types.RoleImplSpec{
				Allow: types.RoleConditions{
...
func testSessionStartContainsAccessRequest(t *testing.T, suite *integrationTestSuite) {
	...
	requestedRole, err := types.NewRoleV3(requestedRoleName, types.RoleImplSpec{
		Options: types.RoleOptions{},
		Allow:   types.RoleConditions{},
	})
	require.NoError(t, err)
	...
	userRole, err := types.NewRoleV3(userRoleName, types.RoleImplSpec{
		Options: types.RoleOptions{},
		Allow: types.RoleConditions{
			Logins: []string{
				suite.Me.Username,
	...
	err = authServer.CreateAccessRequest(context.TODO(), req, tlsca.Identity{})
	require.NoError(t, err)
...
func testKubeAgentFiltering(t *testing.T, suite *integrationTestSuite) {
	...
	plainRole, err := types.NewRole("plain", types.RoleImplSpec{})
	require.NoError(t, err)

	moderatedRole, err := types.NewRole("moderated", types.RoleImplSpec{
		Allow: types.RoleConditions{
...
func createTrustedClusterPair(t *testing.T, suite *integrationTestSuite, extraServices func(*testing.T, *helpers.TeleInstance, *helpers.TeleInstance)) *client.TeleportClient {
	...
	role, err := types.NewRoleV3("dev", types.RoleImplSpec{
		Allow: types.RoleConditions{
			Logins: []string{username},
		},
	})
