...
func testSessionRecordingModes(t *testing.T, suite *integrationTestSuite) {
	...
	for name, test := range map[string]struct {
		...
		t.Run(name, func(t *testing.T) {
			...
			role, err := types.NewRole("devs", types.RoleImplSpec{
...
func testMapRoles(t *testing.T, suite *integrationTestSuite) {
	...
	mainDevs := "main-devs"
	role, err := types.NewRole(mainDevs, types.RoleImplSpec{
		Allow: types.RoleConditions{
			Logins:     []string{username},
			NodeLabels: types.Labels{types.Wildcard: []string{types.Wildcard}},
		},
	...
	auxDevs := "aux-devs"
	role, err = types.NewRole(auxDevs, types.RoleImplSpec{
		Allow: types.RoleConditions{
			Logins:     []string{username},
			NodeLabels: types.Labels{types.Wildcard: []string{types.Wildcard}},
		},
...
func trustedClusters(t *testing.T, suite *integrationTestSuite, test trustedClusterTest) {
	...
	mainDevs := "main-devs"
	devsRole, err := types.NewRole(mainDevs, types.RoleImplSpec{
		Allow: types.RoleConditions{
			Logins:     []string{username},
			NodeLabels: types.Labels{types.Wildcard: []string{types.Wildcard}},
		},
	...
	adminsRole, err := types.NewRole(mainAdmins, types.RoleImplSpec{
		Allow: types.RoleConditions{
	...
	mainOps := "main-ops"
	mainOpsRole, err := types.NewRole(mainOps, types.RoleImplSpec{
		Allow: types.RoleConditions{
			Logins:        []string{username},
	...
	// role specified by mapping remote role "devs" to local role "local-devs"
	auxDevs := "aux-devs"
	auxRole, err := types.NewRole(auxDevs, types.RoleImplSpec{
		Allow: types.RoleConditions{
			Logins:     []string{username},
			NodeLabels: types.Labels{types.Wildcard: []string{types.Wildcard}},
		},
...
func testList(t *testing.T, suite *integrationTestSuite) {
	...
	for _, tt := range tests {
		t.Run(tt.inRoleName, func(t *testing.T) {
			...
			role, err := types.NewRole(tt.inRoleName, types.RoleImplSpec{
				Allow: types.RoleConditions{
...
func testSessionStartContainsAccessRequest(t *testing.T, suite *integrationTestSuite) {
	...
	requestedRole, err := types.NewRole(requestedRoleName, types.RoleImplSpec{
		Options: types.RoleOptions{},
		Allow:   types.RoleConditions{},
	})
	require.NoError(t, err)
	...
	userRole, err := types.NewRole(userRoleName, types.RoleImplSpec{
		Options: types.RoleOptions{},
		Allow: types.RoleConditions{
			Logins: []string{
				suite.Me.Username,
...
func createTrustedClusterPair(t *testing.T, suite *integrationTestSuite, extraServices func(*testing.T, *helpers.TeleInstance, *helpers.TeleInstance)) (*client.TeleportClient, *helpers.TeleInstance, *helpers.TeleInstance) {
	...
	role, err := types.NewRole("dev", types.RoleImplSpec{
		Allow: types.RoleConditions{
			Logins:           []string{username},
			NodeLabels:       types.Labels{types.Wildcard: []string{types.Wildcard}},
